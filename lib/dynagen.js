...
function generatePastel(seedHex, hsl, bgL) {
    ...
    return buildPalette("Dynamic (Pastel)", primaryHex, secondaryHex, {
        ...
        base08: hslToHex(0.00, aS, aL),
        base09: hslToHex(0.08, aS, aL),
        base0A: hslToHex(0.14, aS, aL),
        base0B: hslToHex(0.38, aS - 0.05, aL - 0.02),
        base0C: hslToHex(0.52, aS - 0.05, aL - 0.02),
        base0F: hslToHex(0.92, aS, aL)
    });
}
