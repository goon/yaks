...
function generate(colors, opacity, mode, context) {
    ...
    const base00 = colors.base00 || "#000000";
    const base01 = colors.base01 || base00;
    const base02 = colors.base02 || base01;
    const base03 = colors.base03 || base02;
    const base04 = colors.base04 || "#6a6a7a";
    const base05 = colors.base05 || "#ffffff";
    const base07 = colors.base07 || "#ffffff";
    const base08 = colors.base08 || "#ff0000";
    const base09 = colors.base09 || "#ff8800";
    const base0A = colors.base0A || "#ffff00";
    const base0B = colors.base0B || "#00ff00";
    const base0C = colors.base0C || "#00ffff";
    const base0D = colors.base0D || primary;
    const base0E = colors.base0E || secondary;

    const error = base08;
    const warning = base09;
    const success = base0B;
    const accent = base0A;

    const themeObj = {
        name: "Quickshell Tokens",
        type: "dark",
        colors: {
            ...
            "scrollbarSlider.activeBackground": base03 + "70",
            "scrollbarSlider.background": base02 + "70",
            "scrollbarSlider.hoverBackground": base03 + "70",
        ...
        tokenColors: [
            ...
            },
            {
                ...
                "scope": ["variable", "string constant.other.placeholder", "entity.name.variable.parameter", "entity.name.variable.local", "variable.parameter"],
                "settings": {
                    "foreground": base08
                }
            },
            {
                "name": "Properties",
                "scope": ["variable.other.object.property", "variable.other.property", "support.type.property-name"],
                "settings": {
                    "foreground": base0D
                }
            },
            ...
            {
                "name": "Class, Support",
                "scope": ["entity.name", "support.type", "support.class", "support.origh_classes"],
                "settings": {
                    "foreground": base0A
                }
            },
